...
var PREM_DATA = {
  ...
  lastUnit: {
    n: 7, score: 10, outOf: 15, pct: 67, delta: -2, prevScore: 12
  },
  ...
  unitLog: [
    {
      ...
      tags: [
        { t:'&#9654; Lessons Ready', c:'torange' },
        { t:'Prime Fact Trigger', s:'background:#fff5f5;color:#c53030' },
        { t:'Factor Pairs', c:'tpurple' },
        { t:'Double Constraint', c:'tpurple' }
      ],
      note: '3 lessons delivered (19 May 2026). Targeting trigger gap (3 consecutive units), factor enumeration completeness, and double-constraint permutations. Test pending.',
      status: 'pending'
    },
    {
      n: 7,
