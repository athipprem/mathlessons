...
var PREM_DATA = {
  ...
  lastUnit: {
    ...
    patternInsight: 'Marked on the paper: Part 1 10/12, Recall 3/4. Independently re-added and confirmed to match exactly &mdash; no discrepancy found, unlike U60 Q15 and Milestone 6, which both had a marked total that did not match an independent recount. <strong>Basic 3/3 &middot; Intermediate 4/5 &middot; Applied 3/4 &middot; Recall 3/4</strong> (up from 0/4 at U61 &mdash; moving the Recall Round to the FRONT of the paper worked). <strong>The unit\'s own target skill &mdash; converting a division result from improper fraction to mixed number &mdash; appears in some form across 9 of the 12 Part-1 questions, and 8 of those 9 are correct</strong>, with the lone miss (Q8, wrote 15/3 for 4&frac23;, no working shown) an isolated slip rather than a repeat of U61\'s abandon-at-the-conversion pattern, since the identical mechanic landed correctly on Q3, Q4, Q9a and Q10a. Two other misses, both distinct from the unit\'s content: <strong>R3 (divisibility)</strong> repeats the exact error shape of U61\'s R16 &mdash; wrote 960 (a genuine common multiple of 6 and 8, but not the largest 3-digit one; 984 is) &mdash; and <strong>Q11 (fraction of a set, chained with NOT)</strong> has no legible working, wrong (wrote 3, correct 4), new content that tested clean at U61.',
    analysisLabel: 'Next: Unit 63 &mdash; Fraction &times; Fraction (built 24 Sep 2026, Prem\'s own request)',
    analysisInsight: 'Provenance was unconfirmed when this record was first written; Lui has since confirmed the paper was sat fully independently (24 Sep 2026). U63 re-checks U62 Q11\'s exact NOT-chain shape with the working enforced, and probes the stop-at-first-multiple divisibility habit a third time (R4, fresh numbers) &mdash; if it recurs a third time it moves from "finding" to "named habit" in the finish-the-question band rather than triggering a re-teach. The Recall Round stays at the front permanently, now validated across two sittings (0/4 last, 3/4 first). Full write-up in TEST_RECORD_U62.md and the Executive Summary.',
    qSummary: '<strong>Basic 3/3 | Intermediate 4/5 | Applied 3/4</strong> — Part 1 10/12 (83%) | <strong>Recall 3/4</strong>',
    qBreakdown: [
      { q:'R1', topic:'Recall: Average Changes (maintenance)', lvl:'k', pass:true,  note:'&#10003; 20, after a scratched-out first attempt then self-corrected.' },
      { q:'R2', topic:'Recall: Linear Equation, Solve for n (maintenance)', lvl:'k', pass:true,  note:'&#10003; n=8.' },
      { q:'R3', topic:'Recall: Divisibility — Largest 3-Digit Multiple of 24', lvl:'k', pass:false, note:'&#10007; wrote 960; correct 984. 960 is genuinely divisible by both 6 and 8 (working shows the check) but is not the LARGEST 3-digit multiple &mdash; same error shape as U61\'s R16.' },
      { q:'R4', topic:'Recall: Remainders, Simultaneous Congruence (maintenance)', lvl:'k', pass:true,  note:'&#10003; 13.' },
      { q:'Q1', topic:'Division &rarr; Mixed Number (Word Problem)', lvl:'w', pass:true,  note:'&#10003; 8&frac12; m.' },
      { q:'Q2', topic:'Improper &rarr; Mixed Number', lvl:'w', pass:true,  note:'&#10003; 3&frac12;.' },
      { q:'Q3', topic:'Mixed &rarr; Improper Fraction', lvl:'w', pass:true,  note:'&#10003; 11/5.' },
      { q:'Q4', topic:'Division &rarr; Mixed Number (Word Problem)  &#9733;', lvl:'m', pass:true,  note:'&#10003; 2&frac35; m, working shown (13&divide;5 as 13&times;1/5, then converted).' },
      { q:'Q5', topic:'Division &rarr; Mixed Number (Word Problem)  &#9733;', lvl:'m', pass:true,  note:'&#10003; 2&frac12;, no computation shown beyond the answer.' },
      { q:'Q6', topic:'Compare Two Mixed/Improper Values  &#9733;', lvl:'m', pass:true,  note:'&#10003; 3&frac14;, working converts 19/6 to 3&frac16; and compares side-by-side.' },
      { q:'Q7', topic:'Ratio/Bar Model, Find The Whole  &#9733;', lvl:'m', pass:true,  note:'&#10003; 35, no working shown.' },
      { q:'Q8', topic:'Mixed &rarr; Improper Fraction (4&frac23;)  &#9733;', lvl:'m', pass:false, note:'&#10007; wrote 15/3; correct 14/3. No working shown &mdash; numerator off by one. Isolated: the identical mechanic was correct on Q3, Q4, Q9a and Q10a.' },
      { q:'Q9', topic:'Division &rarr; Mixed Number + Interpretation  &#9733;&#9733;', lvl:'h', pass:true,  note:'&#10003; (a) 4&frac56; (b) 4 full boxes, 5 left over &mdash; both parts correct.' },
      { q:'Q10',topic:'Division &rarr; Mixed Number, Then &times;3  &#9733;&#9733;', lvl:'h', pass:true,  note:'&#10003; (a) 5&frac12; m (b) 16&frac12; m &mdash; both parts correct.' },
      { q:'Q11',topic:'Fraction of a Set, Chained with NOT  &#9733;&#9733;', lvl:'h', pass:false, note:'&#10007; wrote 3; correct 4 (3/7 of 28=12 walk, NOT-walk=16, 1/4 of 16=4 by bus). No legible working &mdash; only a faint smudge in the margin. New content that tested clean at U61.' },
      { q:'Q12',topic:'Reverse-Solve For The Whole, Then Divide  &#9733;&#9733;', lvl:'h', pass:true,  note:'&#10003; 6&frac34;, extensive messy scratch working converging on 27&divide;4=6&frac34;.' }
    ]
  },
  _U61archived: {
  ...
  _M6archived: {
    ...
    patternInsight: '<strong>Marking discrepancy (2nd on record, after U60 Q15):</strong> the paper\'s own section subtotals (Basic 3, Intermediate 5, Applied 3, Kangaroo 1) sum to 12, not the 11 written in the score box — a simple addition slip, re-verified question by question. Tier split: <strong>Basic 3/3 (100%) &middot; Intermediate 5/6 (83%) &middot; Applied 3/6 (50%) &middot; Kangaroo 1/5 (20%).</strong> <strong>Headline: Q9 (reverse triangle formula, area=54cm&sup2;/base=12cm&rarr;height) came back correct, clean and uncoached</strong> &mdash; the exact skill that scored 0/5 independently at U60 and only "passed" with Lui coaching on the retest. This is the first real independent evidence the skill transfers solo; the Algebraic-rearrangement depth standard is now marked <strong>VALIDATED</strong>. Every miss on this paper was deferred, decayed, or never-taught &mdash; <strong>zero misses on current school-aligned content</strong> (Q1&ndash;7, Q9, Q10, Q12, Q14 all correct).',
    analysisLabel: 'Next: Unit 61 &mdash; opens Cycle 7 (Shaping Maths 5A Ch.3), gated on activity-book pages from Lui',
    analysisInsight: 'Q13 (U56 Brick 1 probe) and Q15 (U57 probe) were both left blank &mdash; Brick 1\'s "Total Minus Bad" content did not survive its first genuinely independent test, confirming the counting track resets fully whenever it reopens; do not treat it as banked. Kangaroo collapsed from 4/5 (M3) to 1/5: a clock-angle question on untaught material, a fencepost/boundary regression on a previously well-drilled skill (5th-from-left + 9th-from-right, wrote 15 not 13), a genuine new "product of consecutive numbers" misread (searched near 132&divide;2 instead of &radic;132), and a botched 10-item listing count &mdash; only the logic-grid puzzle (Q20) landed cleanly. Refines Cycle 7\'s own premise: Intermediate held at 83%, not the 40% ASMOPSS predicted &mdash; <strong>the real gap is retention of old material under mixed conditions</strong>, which is exactly what the new scored Recall Round (from U61) is built to target. Full write-up in the Executive Summary; build plan is BUILD_PLAN_MATH_U61_Fractions.md.',
    qSummary: '<strong>Basic 3/3 | Intermediate 5/6 | Applied 3/6 | Kangaroo 1/5</strong> — 12/20 (60%) verified, marked 11/20',
    qBreakdown: [
      { q:'Q1', topic:'Fraction of a Set (U58)', lvl:'w', pass:true,  note:'&#10003; 10 (2/9 of 45).' },
      { q:'Q2', topic:'Order of Operations (U59)', lvl:'w', pass:true,  note:'&#10003; 54 (5+(4+3)&sup2;).' },
      { q:'Q3', topic:'Probability (U55)', lvl:'w', pass:true,  note:'&#10003; 1/4 (P(yellow), 3 of 12 marbles).' },
      { q:'Q4', topic:'Direct Area (U60)', lvl:'m', pass:true,  note:'&#10003; 38 m&sup2; (b19,h4).' },
      { q:'Q5', topic:'Floor-by-Floor Volume (U54)', lvl:'m', pass:true,  note:'&#10003; 140 (4 floors of 7&times;5).' },
      { q:'Q6', topic:'Table With A Scale Key (U51)', lvl:'m', pass:true,  note:'&#10003; 10 (Mia 6 blocks vs Theo 4 blocks, &times;5).' },
      { q:'Q7', topic:'PEMDAS Word Problem (U59)', lvl:'m', pass:true,  note:'&#10003; 32 (4&times;7+10&minus;6).' },
      { q:'Q8', topic:'Combinations Backward (U53)', lvl:'m', pass:false, note:'&#10007; wrote 17; correct 18 (C(n,2)=153). No working shown &mdash; reads as an unsupported guess under time pressure, not a forgotten method (this skill was flagged fully secure after U53).' },
      { q:'Q9', topic:'Reverse Triangle Formula (U60)  &#9733;', lvl:'m', pass:true,  note:'&#10003; 9 cm (area54,base12) &mdash; <strong>clean, uncoached, the first independent evidence for the Algebraic-rearrangement depth standard.</strong> Wrote "9 cm&sup2;" (label slip, number correct).' },
      { q:'Q10',topic:'Chained Fraction Word Problem (U58)  &#9733;', lvl:'h', pass:true,  note:'&#10003; 6 (3/5 of 40=24 in art, 1/4 of 24=6 in both).' },
      { q:'Q11',topic:'Two-Skill Chain (U52)  &#9733;', lvl:'h', pass:false, note:'&#10007; blank ("?"); correct 14. No attempt.' },
      { q:'Q12',topic:'Reverse Probability (U55)  &#9733;', lvl:'h', pass:true,  note:'&#10003; 25 (orange = 40&minus;3/8&times;40).' },
      { q:'Q13',topic:'Choose 3 / Total Minus Bad (U56 Brick 1 probe)  &#9733;', lvl:'h', pass:false, note:'&#10007; blank ("?"); correct 100. Brick 1\'s first genuinely independent test &mdash; did not survive.' },
      { q:'Q14',topic:'Digit Puzzle (U51)  &#9733;&#9733;', lvl:'h', pass:true,  note:'&#10003; 36 (&#9733;+&#9650;=13, &#9733;&minus;&#9650;=5 &rarr; 9,4 &rarr; 9&times;4=36).' },
      { q:'Q15',topic:'Choose 3 / Total Minus Bad (U57 probe)  &#9733;&#9733;', lvl:'h', pass:false, note:'&#10007; blank ("?"); correct 46. Expected miss &mdash; probes the HELD U57 track, confirmed nothing survived.' },
      { q:'Q16',topic:'Kangaroo — Clock Angle', lvl:'k', pass:false, note:'&#10007; wrote "0&deg; or 360&deg;"; correct 7.5&deg; (3:15). Untaught material.' },
      { q:'Q17',topic:'Kangaroo — Seat Row (Fencepost)', lvl:'k', pass:false, note:'&#10007; working shows 14, wrote 15; correct 13 (5th from left + 9th from right &minus; 1). A boundary-adjustment regression on a previously well-drilled skill.' },
      { q:'Q18',topic:'Kangaroo — Consecutive-Number Product', lvl:'k', pass:false, note:'&#10007; blank ("?"); correct 11 and 12 (product=132). Working shows he searched near 132&divide;2=66 instead of &radic;132&asymp;11.5 &mdash; a genuine new "product" vs "half" misread.' },
      { q:'Q19',topic:'Kangaroo — Triangular Number Pattern', lvl:'k', pass:false, note:'&#10007; wrote 48; correct 55 (10 rows, 1+2+...+10). Botched ad-hoc listing on a 10-item count, some rows repeated/skipped.' },
      { q:'Q20',topic:'Kangaroo — Logic/Deduction', lvl:'k', pass:true,  note:'&#10003; "Mia" &mdash; solved with a clean K/L/M &times; pet elimination grid.' }
    ]
  },
  _U60archived_Retest: {
    n:60, score:13, outOf:15, pct:87, delta:-1, prevScore:14, prevOutOf:15, prevLabel:'U59',
    coached: true, distanceFromClass: 'Lesson content ahead of Prem\'s live class at time of test (pre school-curriculum-pivot backlog)',
    patternLabel: 'U60 — Area of Triangles, Retest — 13/15, but COACHED (not an independent measure)',
    patternInsight: '13/15 (87%) on the rebuilt retest &mdash; Sec A 5/5, Sec B 5/5, Sec C 3/5. <strong>Data-integrity correction (added 11 Sep 2026, per cycle7_plan.md):</strong> this retest was COACHED, not independent &mdash; Lui walked Prem through it and had him fix mistakes on Lesson 2 before/during the attempt, rather than Prem completing it solo. The original write-up (and the Executive Summary entry it came from) described this as a clean independent PASS; that framing was wrong and is corrected here. On the numbers actually written: Section B &mdash; the reverse-the-formula skill (double the area, divide by the known side) that was a total 0/5 non-attempt on the 1st try &mdash; came back a clean 5/5 (Q6,7,8,9,10), and Section A held perfectly (5/5). Section C had two fully-worked, method-correct, single-arithmetic-slip misses at Applied tier: Q12 (rect12&times;7 + tri12&times;4, correct 108, wrote 98 &mdash; slip in the final addition) and Q13 (rect20&times;8&minus;tri9&times;6, correct 133, wrote 132 &mdash; halved 9&times;6 as 28 instead of 27). Prem also showed a strong self-correction habit throughout (wrote the un-halved rectangle value first, crossed it out, wrote the correct halved triangle value) &mdash; a good sign, but not a substitute for an independent result on the one skill this whole retest cycle exists to validate.',
    analysisLabel: 'Next: Milestone 6 (built, verified, ready) &mdash; M6 Q9 is the first genuinely clean, uncoached test of the reverse-triangle-formula skill, then U64',
    analysisInsight: 'Because this result was coached, <strong>the Algebraic-rearrangement depth standard remains UNVALIDATED</strong> &mdash; still believed correct (the lesson revamp\'s logic is sound and Section B\'s working was genuinely strong even under support), but with no clean independent evidence yet. Do not fold Area of Triangles\' reverse-formula skill into spiral maintenance as "confirmed closed" until a solo pass lands. M6 Q9 (the pinned "area=54cm&sup2;, base=12cm, find height" question) is that first clean check; U64 is the second. Per the new standing rule, every future score is logged with whether it was coached, plus the unit\'s distance from Prem\'s live school class. Q12/Q13\'s shared failure shape (correct method, one slipped multiplication/halving step at Applied tier) is a precision note for a future spiral warm-up, not a re-teach trigger. project_chusaki.md and the Executive Summary have been corrected to match this framing (see 11 Sep 2026 entries).',
    qSummary: '<strong>Sec A 5/5 | Sec B 5/5 | Sec C 3/5</strong> — 13/15 (87%) &mdash; <strong>COACHED, not an independent measure</strong>',
    qBreakdown: [
      { q:'Q1', topic:'Direct Area', lvl:'w', pass:true,  note:'&#10003; 36 cm&sup2; (b18,h4) &mdash; wrote 72, crossed out, corrected to 36.' },
      { q:'Q2', topic:'Direct Area', lvl:'w', pass:true,  note:'&#10003; 39 m&sup2; (b13,h6) &mdash; wrote 78, crossed out, corrected to 39.' },
      { q:'Q3', topic:'Direct Area', lvl:'w', pass:true,  note:'&#10003; 33 cm&sup2; (b22,h3) &mdash; wrote 66, crossed out, corrected to 33.' },
      { q:'Q4', topic:'Direct Area', lvl:'w', pass:true,  note:'&#10003; 51 cm&sup2; (b17,h6) &mdash; wrote 102, crossed out, corrected to 51.' },
      { q:'Q5', topic:'Direct Area', lvl:'w', pass:true,  note:'&#10003; 60 cm&sup2; (b24,h5) &mdash; wrote 120, crossed out, corrected to 60.' },
      { q:'Q6', topic:'Reverse — Find Height', lvl:'m', pass:true,  note:'&#10003; 8 cm (area36,base9) &mdash; wrote 16, crossed out, circled corrected 8. Reverse-formula skill: the exact gap this retest cycle targeted.' },
      { q:'Q7', topic:'Reverse — Find Base', lvl:'m', pass:true,  note:'&#10003; 24 cm (area60,height5) &mdash; wrote 48, crossed out, corrected to 24.' },
      { q:'Q8', topic:'Reverse — Find Height  &#9733;', lvl:'m', pass:true,  note:'&#10003; 14 cm (area98,base14) &mdash; wrote 28, crossed out, circled corrected 14.' },
      { q:'Q9', topic:'Composite — Add  &#9733;', lvl:'m', pass:true,  note:'&#10003; 72 m&sup2; (rect9&times;5+tri(9,6)).' },
      { q:'Q10',topic:'Composite — Subtract  &#9733;', lvl:'m', pass:true,  note:'&#10003; 105 cm&sup2; (sq11&times;11&minus;tri(8,4)).' },
      { q:'Q11',topic:'Applied — Reverse Word Problem  &#9733;&#9733;', lvl:'h', pass:true,  note:'&#10003; 18 m (sail area99,height11) &mdash; wrote 36, crossed out, circled corrected 18.' },
      { q:'Q12',topic:'Applied — Composite Add  &#9733;&#9733;', lvl:'h', pass:false, note:'&#10007; wrote 98; correct 108 (tent rect12&times;7+tri(12,4)). Both component multiplications (84, 48) shown correctly in working &mdash; slip in the final addition step, not a method failure.' },
      { q:'Q13',topic:'Applied — Composite Subtract  &#9733;&#9733;', lvl:'h', pass:false, note:'&#10007; wrote 132; correct 133 (garden rect20&times;8&minus;tri(9,6)). Rect 160 correct; triangle half computed as 28 instead of 27 &mdash; a one-off halving slip carried through an otherwise-correct subtraction.' },
      { q:'Q14',topic:'Reasoning — Compare  &#9733;&#9733;', lvl:'h', pass:true,  note:'&#10003; "Equal" (triA(6,14)=42, triB(7,12)=42).' },
      { q:'Q15',topic:'Composite Subtract, Capstone  &#9733;&#9733;', lvl:'h', pass:true,  note:'&#10003; 142 m&sup2; (banner 18&times;9&minus;2&times;tri(5,4)).' }
    ]
  },
  _U60archived_1stAttempt: {
  ...
  _U57archived: {
    ...
    analysisLabel: 'Next: Unit 58 (Fractions, already built) &amp; Unit 59 (PEMDAS, built 27 Aug 2026) &mdash; Brick 2/3 remains HELD, resume later per Lui',
    analysisInsight: 'Per Lui&rsquo;s explicit instruction, this real result was intentionally NOT synced to index.html/prem_data.js/Unit_Test_Log.md immediately after grading (27 Aug 2026) &mdash; it was queued to sync together with the U59 build, which is this update. No new test is being built off this result; it informs a future resumption of the HELD Brick 2/3 track (recommended next steps: a dedicated "finish the zero-edge line" drill; a light arithmetic-scale support table for C(n,3), n=10&ndash;21, mirroring U42&rsquo;s factorial staircase fix; keep at least one BAD-not-GOOD precision question in any future retest). Full write-up in the Executive Summary. Warm-ups (ungraded): W1 (Ratio Substitution) 30g &#10003; correct; W2 (Rectangle Counting, ~7 weeks stale) left blank &mdash; a first, inconclusive sign worth a future check since it&rsquo;s ungraded.',
    qSummary: '<strong>Sec A 3/5 | Sec B 0/5 | Sec C 1/5</strong> — 4/15 (27%) NOT PASSED — weakest score in the Total Minus Bad arc',
    qBreakdown: [
      { q:'Q1', topic:'Not-All-Same (2 colours)', lvl:'w', pass:true,  note:'&#10003; 70.' },
      { q:'Q2', topic:'Not-All-Same (3 colours)', lvl:'w', pass:true,  note:'&#10003; 156.' },
      { q:'Q3', topic:'At-Least-1 (single bad case)', lvl:'w', pass:false, note:'&#10007; blank; correct 164. No attempt.' },
      { q:'Q4', topic:'Not-All-Same (3 colours)', lvl:'w', pass:false, note:'&#10007; wrote 283; correct 333. Fully worked but a multi-digit arithmetic slip early in the chain, not a method failure.' },
      { q:'Q5', topic:'Not-All-Same (2 colours)', lvl:'w', pass:true,  note:'&#10003; 84.' },
      { q:'Q6', topic:'Not-All-Same + zero-edge', lvl:'m', pass:false, note:'&#10007; blank, margin note "zero edge?"; correct 319. Spotted the trigger, never completed the C(2,3)=0 step.' },
      { q:'Q7', topic:'At-Least-1 (single bad case)', lvl:'m', pass:false, note:'&#10007; blank; correct 274. No attempt.' },
      { q:'Q8', topic:'Not-All-Same + zero-edge  &#9733;', lvl:'m', pass:false, note:'&#10007; blank, margin note "zero edge?"; correct 367. Same zero-edge pattern as Q6.' },
      { q:'Q9', topic:'Not-All-Same (3 colours)  &#9733;', lvl:'m', pass:false, note:'&#10007; wrote 170; correct 630. Fully worked, but C(17,3)&rsquo;s first-step multiplication read 172 instead of 272 &mdash; the error cascaded through the rest of the chain.' },
      { q:'Q10',topic:'At-Least-1 (same tray as Q6)  &#9733;', lvl:'m', pass:false, note:'&#10007; blank, margin note "zero edge?"; correct 144. Same zero-edge pattern again.' },
      { q:'Q11',topic:'Not-All-Same (3 colours, no zero)  &#9733;&#9733;', lvl:'h', pass:false, note:'&#10007; blank; correct 894. No attempt.' },
      { q:'Q12',topic:'Not-All-Same, DOUBLE zero-edge  &#9733;&#9733;', lvl:'h', pass:false, note:'&#10007; blank, margin note "zero edge x2?"; correct 202. Spotted BOTH triggers, completed neither.' },
      { q:'Q13',topic:'At-Least-1 (single bad case)  &#9733;&#9733;', lvl:'h', pass:false, note:'&#10007; blank; correct 770. No attempt.' },
      { q:'Q14',topic:'Precision trap — asks for BAD, not GOOD  &#9733;&#9733;', lvl:'h', pass:true,  note:'&#10003; 89, full supporting working. The one purpose-built "read the exact question" trap on the paper &mdash; correct despite the otherwise-collapsed test.' },
      { q:'Q15',topic:'Capstone — Not-All-Same, FOUR colours  &#9733;&#9733;', lvl:'h', pass:false, note:'&#10007; wrote 372; correct 722. Fully worked, same arithmetic-scale cascade as Q4/Q9.' }
    ]
  },
  _U56archived_3rdAttempt: {
    n:56, score:10, outOf:15, pct:67, delta:-4, prevScore:14, prevOutOf:15, prevLabel:'U55',
    coached: true,
    patternLabel: 'U56 — Choose 3 &amp; Total Minus Bad, 3rd attempt (post Brick 1), NOT PASSED but a big jump — Brick 1 gains were COACHED (not an independent measure)',
    patternInsight: '10/15 (67%) <strong>NOT PASSED</strong>, but a big jump &mdash; Sec A 4/5, Sec B 4/5, Sec C 2/5. Trajectory across three attempts: <strong>7 &rarr; 6 &rarr; 10.</strong> This is Prem&rsquo;s third attempt, taken after Lesson 2 was rebuilt as Brick 1 of 3 (single bad-case only, one context, every worked-example number given its own inline reason). Total Minus Bad went from 0/8 correct (every question left blank on the 2nd attempt) to 4/8 correct this time &mdash; and the split is exactly clean: <strong>every single-bad-case, people-context question Brick 1 taught was answered correctly</strong> (Q7, Q8, Q9, and Q11 &mdash; a bigger-pool version of the same shape), 4 for 4. Every question needing content Brick 1 never taught was left <strong>blank, not guessed at</strong>: Q10 &amp; Q12 need the points-on-a-circle framing (Brick 3), Q13 needs multi-case bad with more than one way to break the rule (Brick 2), and Q15 needs the reverse-capstone structure (Brick 3). Prem correctly recognised unfamiliar territory and left it blank rather than misapplying the method &mdash; the disciplined behaviour the programme has been building since the Confidence Session. New, isolated miss: Q4 (11 hikers, choose 3) wrote 115 instead of 165, no working shown &mdash; given every other Lesson-1-style question (Q1,2,3,5,6, and the hardest, reverse-solved Q14) was correct, this reads as an isolated arithmetic slip, not a method regression. <strong>Data-integrity correction (added 11 Sep 2026, per cycle7_plan.md):</strong> this attempt was COACHED &mdash; Lui explained U56/U57 content twice each around this attempt, and Prem retained almost nothing from those explanations (part of why Brick 3 was ultimately held). The clean 4/4 on Brick-1 content is real on the page, but it is not independent evidence that Brick 1 is durably learned.',
    ...
    analysisInsight: 'Following project precedent (remediation always takes the next sequential unit number &mdash; U40&rarr;U41, U49&rarr;U50, U47&rarr;U48, U44&rarr;U45), the remaining Total-Minus-Bad remediation is tracked as <strong>Unit 57</strong> rather than a 4th U56 attempt. Brick 2 (multi-case bad + the "fewer than needed = write 0" edge case) targets Q13. Brick 3 (points/triangles context + reverse-solve/capstone) targets Q10, Q12, and Q15. Both bricks are built and the U57 test is ready, covering only Brick 2/3 content with entirely fresh numbers (none reusing Q4/Q10/Q12/Q13/Q15&rsquo;s seen values) plus 2 spiral-maintenance warm-ups. Q4&rsquo;s slip is a "show your working, even on easy ones" reminder, not a re-teach trigger. <strong>Corrected 11 Sep 2026:</strong> the original write-up called this "about as clean a validation as a lesson redesign can get" and treated Brick 1 as validated &mdash; that overstated it, since the attempt was coached. Brick 1&rsquo;s single-bad-case, people-context skill still needs a genuinely independent check before it is treated as closed.',
  ...
  _U53archived: {
    ...
    analysisLabel: 'Next: Real ASMOPSS 2026 exam (sat 9 Aug 2026, self-graded 50/100 same-day &mdash; OFFICIAL RESULT since confirmed 60.50/100, see below) — see Competitions/ASMOPSS/ for full breakdown, answer key &amp; tier/strand dashboard',
    analysisInsight: 'U53 was the final ASMOPSS-prep unit before the real exam. The real exam confirmed almost question-for-question the gap map this programme had been tracking: every miss traced to harder-tier combinatorics, painted-cube/3D spatial reasoning, or "finish the full question," while every hit landed in the areas called strengths. A full coaching-process review (10 Aug 2026) followed, comparing unit-test vs. real-exam performance &mdash; see coaching-rules memory for the standing rules now in effect (spiral maintenance, standing finish-the-question grading, tier-density practice, Statistics &amp; Probability added to rotation). Programme resumes standard ISA 2027 cadence from U54, targeting 3D spatial reasoning with a genuinely new method (floor-by-floor grid counting, building on Prem&rsquo;s already-proven 2D grid-counting skill instead of the corner/edge/face/inside formulas that failed twice at U49&ndash;U50). <strong>CORRECTION (official result announced, recorded 21 Sep 2026): actual score 60.50/100, not 50/100</strong> &mdash; two of the self-graded misses (Q20 data/arithmetic, Q23 spatial/painted-cube) were actually correct on the official key. Q23 flipping correct means this exam no longer confirms the painted-cube gap as strongly as first thought (U49/U50 still do, independently). Official strand split shows Statistics &amp; Probability as the actual weakest area (44.74%), not spatial reasoning &mdash; see the Executive Summary for the full reconciliation.',
  ...
  scores: [
    ...
    { n:56, score:10, delta:-4,   color:'linear-gradient(135deg,#EF5350,#C62828)', star:false, coached:true },
  ...
  unitLog: [
    ...
    },
    {
      ...
      title: 'Milestone 6 — Units 51&ndash;60 Review (ISA-Style + Kangaroo Diagnostic, Year 5)',
      tags: [
        { t:'12/20 (60%) verified &mdash; marked 11/20 (addition slip)', s:'background:#E8EAF6;color:#283593;font-weight:700' },
        { t:'Basic 3/3 &middot; Intermediate 5/6 &middot; Applied 3/6 &middot; Kangaroo 1/5', c:'torange' },
        { t:'Q9 clean &amp; uncoached &mdash; depth standard now VALIDATED', c:'tgreen' },
        { t:'Zero misses on current school-aligned content', c:'tgreen' },
        { t:'&rarr; Unit 61, opening Cycle 7', c:'torange' }
      ],
      note: 'First tier-split milestone (Basic/Intermediate/Applied), first 20Q ISA+Kangaroo format since M3. <strong>Marking discrepancy (2nd on record, after U60 Q15):</strong> the paper&rsquo;s own section subtotals (3+5+3+1) sum to 12; the score box read 11 &mdash; a simple addition slip, re-verified question by question. <strong>Headline finding: Q9 (reverse triangle formula, area=54cm&sup2;/base=12cm) came back correct, clean and uncoached</strong> &mdash; the exact skill that scored 0/5 independently at U60 and only "passed" with Lui coaching on the retest. This is the first real independent evidence the skill transfers solo; the Algebraic-rearrangement depth standard is now <strong>VALIDATED</strong> (corrected in coaching_rules.md and cycle7_plan.md). Every miss on this paper was deferred, decayed, or never-taught: Q8 (Combinations Backward, U53, unsupported wrong guess), Q11/Q13/Q15 (all blank &mdash; Two-Skill Chain U52, Choose-3/Total-Minus-Bad U56 Brick 1 probe, U57 probe), and Q16&ndash;Q19 (Kangaroo). <strong>Zero misses on current school-aligned content</strong> (Q1&ndash;7, Q9, Q10, Q12, Q14 all correct). Q13&rsquo;s blank result is a real, independent data point that U56 Brick 1 did not survive &mdash; the counting track resets fully whenever it reopens. Kangaroo collapsed 4/5 (M3) &rarr; 1/5 (M6): a clock-angle question on untaught material, a fencepost/boundary regression on a previously well-drilled skill, a genuine new "product of consecutive numbers" misread, and a botched 10-item listing count &mdash; only the logic-grid puzzle (Q20) landed. Refines Cycle 7&rsquo;s premise: Intermediate held at 83%, not the 40% ASMOPSS predicted &mdash; the real gap is retention of old material under mixed conditions, which the new scored Recall Round (from U61) targets directly. Full write-up in the Executive Summary; build plan is <code>BUILD_PLAN_MATH_U61_Fractions.md</code>.',
      status: 'done'
    },
    {
      n: 60,
      ...
      tags: [
        { t:'Retest: 13/15 (87%) — COACHED, not an independent measure', s:'background:#FFF8E1;color:#E65100;font-weight:700' },
        { t:'1st attempt: 8/15 verified — NOT PASSED', s:'background:#FFEBEE;color:#B71C1C;font-weight:700' },
        { t:'Reverse-formula skill: 5/5 on retest, but under live coaching support', c:'torange' },
        { t:'Lesson 2 revamp: deep fraction-derivation + side-switching logic', c:'tgreen' },
        { t:'U60 CLOSED for now — depth standard UNVALIDATED, M6 Q9 is first clean check', c:'torange' }
      ],
      note: 'Fourth unit in the 27 Aug 2026 school-curriculum pivot (Shaping Maths Ch.4: base &amp; height, finding area), following U58 Fractions (15/15) and U59 PEMDAS (14/15). <strong>1st attempt (graded 3 Sep 2026): 8/15 independently verified, NOT PASSED</strong> &mdash; Sec A 5/5 perfect, Sec B 0/5, Sec C 3/5. Prem: "understood nothing at all on Lesson 2." Every single reverse-formula question (Q6, Q7, Q8, Q11 &mdash; the one new idea Lesson 2 was built to teach) was left as a bare non-attempt. Lui reviewed the lesson directly and found screen s1 ("Rearranging The Formula") compressed the algebra into two bare lines with no fraction-form derivation and no explanation of WHY moving a term across "=" flips its operation &mdash; an under-application of the project&rsquo;s standing step-by-step-granularity rule on this one screen. <strong>Response:</strong> <em>Triangles_Lesson_MissingPieceAndComposite.html</em> screen s1 was rebuilt into two screens using Lui&rsquo;s own worked breakdown, and the U60 test was entirely rebuilt from scratch (all-new 15Q + 2 new warm-ups), verified via Python and an exhaustive duplicate-pair scan (zero collisions). A marking discrepancy was also found and corrected on the original attempt&rsquo;s Q15 &mdash; real score is 8/15, not the 7/15 marked on paper. <strong>Retest (graded 9 Sep 2026): 13/15 (87%)</strong> &mdash; Sec A 5/5, Sec B 5/5 (reverse-formula, the exact 0/5 gap, now clean), Sec C 3/5 (two Applied-tier arithmetic slips, Q12/Q13). <strong>Data-integrity correction (added 11 Sep 2026, per cycle7_plan.md):</strong> this retest was COACHED &mdash; Lui walked Prem through it and had him fix mistakes on Lesson 2 rather than Prem completing it independently. The original write-up and Executive Summary entry called this a clean independent PASS; that was wrong and has been corrected. U60 is closed for the purposes of moving on to Milestone 6, but the Algebraic-rearrangement depth standard itself remains <strong>UNVALIDATED</strong> until a genuinely uncoached result confirms it &mdash; M6 Q9 (pinned: area=54cm&sup2;, base=12cm) is that first clean test, then U64.',
      status: 'done'
    },
    {
      n: 59,
    ...
    },
    {
      ...
      title: 'Art of Counting — Total Minus Bad: Multi-Case &amp; Zero-Edge (Brick 2 Retest) — HELD, real result 4/15',
      tags: [
        { t:'4/15 (27%) &#10007; NOT PASSED — weakest score in the arc', s:'background:#fff5f5;color:#c53030;font-weight:700' },
        { t:'HELD 27 Aug 2026 — paused, not cancelled', s:'background:#F3E8FF;color:#4A148C;font-weight:700' },
        { t:'Core framework + precision-trap Q14 intact at small scale', c:'tgreen' },
        { t:'Zero-edge recognised (margin notes) but not completed', c:'torange' },
        { t:'&rarr; U58 Fractions + U59 PEMDAS (school-curriculum pivot)', c:'torange' }
      ],
      note: 'Remediation unit, numbered U57 rather than a 4th U56 attempt, following project precedent (U40&rarr;U41, U49&rarr;U50, U47&rarr;U48, U44&rarr;U45). Brick 2 (multi-case bad &mdash; sum several bad cases together + the "fewer than needed = write 0" edge case, Counting_Lesson_MultiConstraint_Brick2.html) targets U56 3rd-attempt Q13 (marbles, not-all-same-colour). First built 20 Aug 2026 in the same worked-example format as Brick 1, but Lui reported it "too hard &amp; confusing" &mdash; hard enough that even an adult reading it cold couldn&rsquo;t follow it. Rebuilt 24 Aug 2026 from scratch as an interactive game ("Bag Sorting Challenge"): Prem sorts real handfuls of a small counter jar by hand first (discovering the zero-edge case himself), THEN meets the Choose-3 shortcut, THEN plays a bigger jar as 5 click-to-reveal scored rounds, THEN predicts-before-reveals the zero-trap and the "not all same vs at least 1" discrimination. Fully built and verified via headless simulation. <strong>Prem sat the real test before the 27 Aug HELD decision &mdash; graded 27 Aug 2026: 4/15 (27%), the weakest score anywhere in the Total Minus Bad arc (7&rarr;6&rarr;10&rarr;4), and the concrete evidence the HELD call was built on.</strong> Full breakdown in the [[lastUnit]] object above and the Executive Summary. Even after two redesigns, this content is still too hard for Prem at this time &mdash; <strong>the whole Brick 2/3 track remains HELD/paused, not cancelled</strong> &mdash; both lesson files and the Brick-2-only test remain built and ready, and the unit resumes (renumbered) whenever Lui says so. U58/U59 onward pivots to Prem&rsquo;s real school curriculum instead (Fractions, PEMDAS, Area of Triangles, Ratio, Volume) &mdash; see the entries above. Per Lui&rsquo;s instruction, this real result was deliberately held back from index.html/prem_data.js/Unit_Test_Log.md until the U59 build (this sync).',
      status: 'held'
    },
    {
      n: 56,
      ...
      tags: [
        ...
        { t:'COACHED — not an independent measure (see 11 Sep 2026 correction)', s:'background:#FFF8E1;color:#E65100;font-weight:700' },
        { t:'4/4 correct on Brick-1 content, but under coaching support', c:'torange' },
        { t:'Untaught content (Q10,12,13,15) left blank, not guessed', c:'tgreen' },
        { t:'Trajectory: 7 &rarr; 6 &rarr; 10', c:'torange' },
        { t:'&rarr; Bricks 2 &amp; 3 built as Unit 57 (Brick 3 later HELD)', c:'torange' }
      ],
      note: '10/15 (67%) &#10007; <strong>NOT PASSED</strong>, but a big jump &mdash; Sec A 4/5, Sec B 4/5, Sec C 2/5. Prem&rsquo;s 3rd attempt at U56, taken after Lesson 2 was rebuilt as Brick 1 of 3. Trajectory across three attempts: 7&rarr;6&rarr;10. Total Minus Bad went from 0/8 (every question blank on the 2nd attempt) to 4/8 correct &mdash; and the split is exactly clean: every single-bad-case, people-context question Brick 1 taught (Q7, Q8, Q9, Q11 &mdash; a bigger-pool version of the same shape) was answered correctly, 4/4. Every question needing content Brick 1 never taught (Q10 &amp; Q12 need points-on-a-circle, Q13 needs multi-case bad, Q15 needs the reverse-capstone) was left blank, not guessed at &mdash; Prem correctly recognised unfamiliar territory rather than misapplying the method. New isolated miss: Q4 (11 hikers, choose 3) wrote 115 not 165, no working shown &mdash; reads as an arithmetic slip given every other Lesson-1 question was correct. &rarr; Following project precedent, the remaining remediation (Bricks 2 &amp; 3, targeting Q10/Q12/Q13/Q15) is built and numbered Unit 57 rather than a 4th U56 attempt. <strong>Data-integrity correction (added 11 Sep 2026, per cycle7_plan.md):</strong> this attempt was COACHED &mdash; Lui explained U56/U57 content twice each around this attempt and Prem retained almost nothing from those explanations (part of why Brick 3 was later held). The 4/4 on Brick-1 content shown above is real on the page but is not independent evidence Brick 1 is durably learned; the original write-up calling this "Brick 1 validated" overstated it.',
      status: 'done'
    },
    {
      n: 55,
    ...
    },
    {
      ...
      tags: [
        ...
        { t:'&rarr; Real ASMOPSS 2026 exam, sat 9 Aug (official: 60.50/100)', c:'torange' }
      ],
      note: '11/15 &#10007; <strong>NOT PASSED</strong>, but the best score since U49 (8&rarr;7&rarr;9&rarr;11 trend) &mdash; Sec A 4/5, Sec B 5/5 PERFECT, Sec C 2/5. Combinations Backward is fully secure: every appearance on the paper (7 questions across all 3 tiers) was correct, doubling step shown every time. Circular Double/Triple-Repeat is more solid than the score suggests &mdash; most misses were arithmetic-scale slips or abandoned big-number attempts on a correctly-identified method, not rule confusion, including Q13 where Prem correctly extended the 2-group rule to a never-taught 3-group case and only lost the answer to one mid-division slip. This was the final ASMOPSS-prep unit; the real exam followed the next day (9 Aug), self-graded 50/100 same-day &mdash; see Competitions/ASMOPSS/ for the full breakdown, answer key, and tier/strand dashboard. A full coaching-process review followed (10 Aug 2026); see coaching-rules memory and the U54 entry above. <strong>OFFICIAL RESULT (announced, recorded 21 Sep 2026): 60.50/100</strong> &mdash; T-score 66.11, percentile 92.08, rank 303/3,941 nationally. Two self-graded misses (Q20, Q23) were actually correct; official strand split names Statistics &amp; Probability the real weak spot (44.74%), not spatial reasoning. Full reconciliation in the Executive Summary.',
      status: 'done'
    },
    {
      n: 52,
...
PREM_DATA.renderQBreakdown = function(containerId) {
  ...
  var lvlClass = { w:'lw', m:'lm', h:'lh', k:'lh' };
  var lvlText  = { w:'Warm', m:'Med', h:'Hard', k:'Kangaroo' };
  var html = '';
  // Card header
  var unitWord = (typeof u.n === 'string' && u.n.charAt(0) === 'M') ? 'Milestone ' : 'Unit ';
